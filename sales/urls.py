...
urlpatterns = [
    ...
    path('increase-quantity/<int:sale_detail_id>/', views.increase_quantity, name='increase_quantity'),
    path('decrease-quantity/<int:sale_detail_id>/', views.decrease_quantity, name='decrease_quantity'),
